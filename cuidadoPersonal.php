...
$mensajewhatsapp="Hola,soy:    
hice una compra de:          
y me gustaria retirarlo el dia:          
en:          .";
$enlancewhatsapp="https://api.whatsapp.com/send?phone=5491135844944&text=" . urlencode($mensajewhatsapp);
?>
...
<div class="container mt-4 fix-footer">
  ...
  font-family: 'Lobster', cursive; text-shadow:0px 0px 1px #000000;">Cuidado Personal</h3>
  <h5 class="sub-titulo">Recorda que podes coordinar el retiro sin cargo a traves de <a target="_blank"style="color:#75b798;text-decoration:none;" href="<?php echo $enlancewhatsapp; ?>" >WhatsApp</a> en Olivos de lunes a viernes y Santa fé y Pellegrini los fines de semana.</h5>
    </div>
<div class="row">
